...
const TripCard = ({ viaje, index }) => {
    ...
    const waText = viaje.texto_whatsapp || `Viaje a ${viaje.destino_especifico}`;
    ...
    useEffect(() => {
        const fetchTrips = async () => {
            try {
                ...
                const colombia = data.filter(
                    (t) => t.pais && String(t.pais).toUpperCase() === 'COLOMBIA'
                );
                ...
                const g = colombia.reduce((acc, trip) => {
    ...
    return (
        <div className="tv-page">
            ...
            <header className="tv-hero">
                ...
                <div className="tv-hero-inner">
                    <p className="tv-breadcrumb">
                        <Link to="/">Inicio</Link>
                        <span>/</span> Destinos
                        <span>/</span> <strong>Colombia</strong>
                    </p>
                    <span className="tv-hero-tag">EL PAÍS DE LOS MIL PAISAJES</span>
                    <h1 className="tv-hero-title">
                        <span>DESCUBRE</span>
                        <span className="tv-hero-accent">COLOMBIA.</span>
                    </h1>
                    <p className="tv-hero-sub">
                        Del Caribe a los Andes, del desierto a la selva.
            ...
            <section className="tv-cta">
                <h2>¿SUEÑAS CON OTRO<br />RINCÓN DEL MUNDO?</h2>
                <p>Colombia es solo el comienzo. Explora todos nuestros destinos.</p>
